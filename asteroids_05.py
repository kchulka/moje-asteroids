...
- třída Laser() 
- přidání vystřelení asteroidu raketou - klávesa 'shot' (key. Space)
- metoda SpaceSip.shot() - vystřelení laseru
- seznam SpaceShip.lasers - seznam laserů vystřelených raketou
"""
import pyglet
...
class SpaceObject:
    ...
    def out_of_window(self):
        """ mimo okno? - objekt je vrácen do okna """
...
class SpaceShip(SpaceObject):
    ...
    ACCELERATION        = 5 # akcelerace ryclosti rakety 
